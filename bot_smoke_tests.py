"""
Standalone test runner for the Bisha Admissions Agent API.
...
TEST_CASES: list[TestCase] = [
    ...
    TestCase(
        ...
        expected_status="escalate",
        accepted_reasons=("outside_scope", "requires_human_action"),
        expected_reply_contains=("خارج نطاق اختصاص", "المختصة"),
    ),
]
